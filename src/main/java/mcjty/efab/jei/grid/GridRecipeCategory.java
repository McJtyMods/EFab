...
public class GridRecipeCategory extends BlankRecipeCategory<GridRecipeWrapper> {
...
//        RenderHelper.getMCFontrenderer().drawString("and " + ConfigMachines.Laser.crystalLiquidPerCatalyst + "mb crystal", 24, 10, 0xffffffff, true);
    ...
    @Override
    public void setRecipe(IRecipeLayout recipeLayout, GridRecipeWrapper recipeWrapper, IIngredients ingredients) {
