...
public class MonitorRenderer extends TileEntitySpecialRenderer<MonitorTE> {
    ...
    public static void renderHud(MonitorTE monitorTE, double x, double y, double z) {
        renderHud(monitorTE, x, y, z, 0.5f, false);
    }

    public static void renderHud(MonitorTE monitorTE, double x, double y, double z, float scale, boolean faceVert) {
